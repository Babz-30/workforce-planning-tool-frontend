...
Download and install from [LTS version](https://nodejs.org/en).
...
Check successful installation of node.js.

### `npx create-react-app workforce-planning-tool-frontend`
