...
//         Identify missing skill sets across the organization
//       </p>
//       <div className="skill-gap-controls-inline">
//         <input
//           type="text"
...
//         >
//           <option value="gap-desc">Gap ↓</option>
//           <option value="gap-asc">Gap ↑</option>
//           <option value="skill-asc">Skill A–Z</option>
//           <option value="skill-desc">Skill Z–A</option>
//           <option value="required-desc">Required ↓</option>
//           <option value="required-asc">Required ↑</option>
